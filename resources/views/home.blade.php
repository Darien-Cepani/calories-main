@extends('layouts.app')
<?php
$cal = DB::table('calories')->get();
$calories = $cal->isEmpty() ? 0 : $cal[0]->calories; // Default to 0 if empty
?>
...
$total_kcal = DB::table('meals')
    ...
    // Handle the case where no meals exist. You could set:
    $total_kcal = 0;
    $bgcolor = 'secondary'; // Use a neutral color
    $msg = 'No meals recorded yet.';
}
?>
